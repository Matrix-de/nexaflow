          ...
          <div className="space-y-6">
            <div className="animate-fade-in-up animation-delay-200">
              <div className="flex flex-col items-center justify-center text-center space-y-2">
                <GooeyText
                  texts={["Launch Your", "Power Your", "Supercharge Your", "Transform Your"]}
                  morphTime={1}
                  cooldownTime={1.5}
                  className="font-bold w-full"
                  textClassName="bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent text-5xl md:text-7xl lg:text-8xl"
                />
